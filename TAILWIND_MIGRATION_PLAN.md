...
**Текущий статус**: Использует `wot_record_skin.css`, частично Tailwind

- [ ] Удалить `static/css/wot_record_skin.css`
- [ ] Переписать карточки реплеев на Tailwind
- [ ] **Адаптивная сетка**:
  - [ ] Мобильные (< 640px): 1 колонка
  - [ ] Планшеты (640px-1024px): 2 колонки
  - [ ] Десктоп (> 1024px): текущий layout
- [ ] Сортировки (`sorters`):
  - [ ] На мобильных: dropdown или accordion
  - [ ] На десктопе: grid как сейчас
- [ ] Карточки реплеев (`.tovabb`):
  - [ ] Переписать на Tailwind
  - [ ] Адаптивные размеры изображений
  - [ ] Touch-friendly hover эффекты
- [ ] Статистика в карточках:
  - [ ] На мобильных: уменьшить иконки и шрифты
  - [ ] На десктопе: текущие размеры
- [ ] Фильтры и сортировки:
  - [ ] На мобильных: collapsible панель
  - [ ] На десктопе: фиксированная панель

**CSS для удаления**:
- `static/css/wot_record_skin.css` (большой файл с кастомными стилями)
...
**Текущий статус**: Использует `replays_filters.css`

- [ ] Удалить `static/css/replays_filters.css`
- [ ] Переписать форму на Tailwind
- [ ] **Адаптивная форма**:
  - [ ] Мобильные (< 640px): 1 колонка
  - [ ] Планшеты (640px-1024px): 2 колонки
  - [ ] Десктоп (> 1024px): 3 колонки (как сейчас)
- [ ] Chips (чекбоксы/радио):
  - [ ] Адаптивный размер
  - [ ] Touch-friendly (минимум 44px на мобильных)
- [ ] Поля ввода:
  - [ ] Full-width на мобильных
  - [ ] Адаптивные размеры на десктопе
- [ ] Кнопки действий:
  - [ ] На мобильных: full-width, стек
  - [ ] На десктопе: inline, как сейчас
- [ ] Списки танков и версий:
  - [ ] Адаптивная высота
  - [ ] Touch-friendly скролл

**CSS для удаления**:
- `static/css/replays_filters.css`
...
**Всего задач**: 150+
**Выполнено**: 28
**В процессе**: 5 (тестирование компонентов)
**Осталось**: 117+
...
### Приоритет 1: Тестирование базовых компонентов
- [ ] Протестировать на iPhone SE (375px)
- [ ] Протестировать на iPad (768px)
- [ ] Протестировать на Desktop (1024px+)
- [ ] Добавить мобильное меню в navbar

### Приоритет 2: Миграция страниц реплеев
- [ ] Список реплеев (list.html) - КРИТИЧНО
- [ ] Фильтры (filters.html)
- [ ] Детали реплея (detail.html) - с особым вниманием

---

**Дата создания плана**: 2025-10-30
**Последнее обновление**: 2025-10-30 10:30
