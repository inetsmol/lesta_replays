...
## 🧩 Фаза 2: Базовые компоненты (Высокий приоритет) 🔄
...
- [ ] Проверена текущая реализация (уже Tailwind)
- [ ] Протестирован на мобильных
- [ ] Drag-and-drop работает
- [ ] Адаптивные размеры модального окна
- [ ] Протестирован на touch-устройствах
...
- [ ] Удален `static/css/alert_modal.css`
- [ ] Переписан на Tailwind + Alpine.js
- [ ] Адаптивные размеры
...
- [ ] Мигрировать pagination
- [ ] Начать миграцию alert_modal и dev_banner
